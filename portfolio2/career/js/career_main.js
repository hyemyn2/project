$(function(){
    ...
    smallCon.forEach(function(i,k){
        smallCon[k].addEventListener('click',function(){
            console.log(k)
            if(k==0){
                window.location.pathname = "portfolio2/career/apply/career_apply_delivery.html";
            }else if(k==1){
                window.location.pathname = "portfolio2/career/career_family.html";
            }else if(k==2){
                window.location.pathname = "portfolio2/index.html";
            }
