$(function(){
    ...
    bigCon.addEventListener('click',function(){
        window.location.pathname = "/career/apply/career_apply_jobs.html";
    });
    ...
    smallCon.forEach(function(i,k){
        smallCon[k].addEventListener('click',function(){
            console.log(k)
            if(k==0){
                window.location.pathname = "/career/apply/career_apply_delivery.html";
            }else if(k==1){
                window.location.pathname = "/career/career_family.html";
            }else if(k==2){
